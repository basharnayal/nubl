...
<div class="hidden sm:flex sm:space-x-8">
    ...
    <x-dropdown align="left" width="48">
        <x-slot name="trigger">
            <button class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition duration-150 ease-in-out {{ request()->is('admin/users*') || request()->is('admin/manage/*') ? 'border-nubl-teal-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                {{ __('Users') }}
...
<div class="sm:hidden space-y-1">
    ...
    <x-responsive-nav-link :href="route('admin.manage.users.index')" :active="request()->routeIs('admin.manage.*')">
        {{ __('User Management') }}
    </x-responsive-nav-link>
