<x-app-layout title="Admin Dashboard" is-header-blur="true">
    <div class="mt-4 grid grid-cols-12 gap-4 transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div
                class="col-span-12 flex flex-col transition-all duration-[.25s] lg:col-span-3 lg:pr-0">
                <h2
            ...
            <div
                class="is-scrollbar-hidden col-span-12 flex space-x-4 overflow-x-auto transition-all duration-[.25s] lg:col-span-9 lg:pl-0">
