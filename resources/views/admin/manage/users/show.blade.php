        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div><dt class="text-sm text-gray-500">{{ __('Phone') }}</dt><dd class="text-gray-900">{{ $user->phone_number || $user->providerProfile?->phone_number ? \App\Support\PhoneHelper::formatForDisplay($user->phone_number ?? $user->providerProfile?->phone_number) : '-' }}</dd></div>
            ...
            @if($user->providerProfile)
                ...
                <section class="rounded-lg shadow p-6 bg-white">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        <div><x-input-label :value="__('Phone')" /><p class="mt-1 text-gray-900">{{ ($profile->phone_number ?? $user->phone_number) ? \App\Support\PhoneHelper::formatForDisplay($profile->phone_number ?? $user->phone_number) : '-' }}</p></div>
