<x-guest-layout title="{{ __('Donation Successful') }}">
    ...
    <div class="mt-6 flex flex-wrap justify-center gap-3">
        @if ($payment)
            <a href="{{ route('guest.donation.receipt', $payment) }}" class="btn inline-flex items-center gap-2 bg-primary text-white hover:bg-primary-focus px-5 py-2 dark:bg-accent dark:hover:bg-accent-focus">
