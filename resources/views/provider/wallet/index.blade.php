            ...
            <div class="card p-6">
                <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <dd class="mt-1 text-2xl font-semibold tabular-nums text-slate-900 dark:text-navy-50">{{ number_format((float) $wallet->balance, 2) }} <span class="text-base font-normal text-slate-500">SAR</span></dd>
                    </div>
                    <div>
